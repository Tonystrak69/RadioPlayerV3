...
async def not_chat(_, m: Message):
    ...
    k=await m.reply_photo(photo="https://telegra.ph/file/283a09e56c3180315295f.jpg", caption="**Sorry, You Can't Use This Bot In This Group! 😈", reply_markup=InlineKeyboardMarkup(buttons))
    await mp.delete(m)
